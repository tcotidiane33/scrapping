...
pages = [
    'https://www.airp.ci/fr/liste-officines?term_node_tid_depth=18',
    'https://www.airp.ci/fr/liste-officines?term_node_tid_depth=18&page=1',
    'https://www.airp.ci/fr/liste-officines?term_node_tid_depth=18&page=2',
    'https://www.airp.ci/fr/liste-officines?term_node_tid_depth=18&page=3',
]
...
df.to_excel('Riviera.xlsx', index=False)
