...
pages = [
    'https://www.airp.ci/fr/liste-officines?term_node_tid_depth=21',
    'https://www.airp.ci/fr/liste-officines?term_node_tid_depth=21&page=1',
    'https://www.airp.ci/fr/liste-officines?term_node_tid_depth=21&page=2',
]
...
df.to_excel('Plateau.xlsx', index=False)
