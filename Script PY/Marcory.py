...
pages = [
    'https://www.airp.ci/fr/liste-officines?term_node_tid_depth=20',
    "https://www.airp.ci/fr/liste-officines?term_node_tid_depth=20&page=1",
    'https://www.airp.ci/fr/liste-officines?term_node_tid_depth=20&page=2',
    'https://www.airp.ci/fr/liste-officines?term_node_tid_depth=20&page=3',
]
...
df.to_excel('Marcory.xlsx', index=False)
