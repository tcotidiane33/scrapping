...
pages = [
    'https://www.airp.ci/fr/liste-officines?term_node_tid_depth=22',
    'https://www.airp.ci/fr/liste-officines?term_node_tid_depth=22&page=1',
]
...
df.to_excel('Port-Bouet.xlsx', index=False)
