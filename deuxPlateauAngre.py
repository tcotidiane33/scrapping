...
pages = [
    'https://www.airp.ci/fr/liste-officines?term_node_tid_depth=17',
    'https://www.airp.ci/fr/liste-officines?term_node_tid_depth=17&page=1',
    'https://www.airp.ci/fr/liste-officines?term_node_tid_depth=17&page=2',
    'https://www.airp.ci/fr/liste-officines?term_node_tid_depth=17&page=3',
    'https://www.airp.ci/fr/liste-officines?term_node_tid_depth=17&page=4',
]
...
df.to_excel('deuxPlateauAngre.xlsx', index=False)
